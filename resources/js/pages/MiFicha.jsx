                ...
                <div className="max-w-7xl mx-auto space-y-12">
                    ...
                    {loading ? (
                        <div className="py-32 flex flex-col items-center justify-center space-y-4">
                            <div className="animate-spin h-12 w-12 border-4 border-[#38C1A3] border-t-transparent rounded-full shadow-lg shadow-teal-500/20"></div>
                                                ...
                                                <Line 
                                                    ...
                                                    options={{
                                                        ...
                                                        scales: { 
                                                            ...
                                                            y: { grid: { borderDash: [5, 5], color: '#F1F5F9' }, ticks: { font: { weight: 'bold', size: 9 }, color: '#94A3B8' } } 
                                                        }
                                                    }}
                                                />
                                            ) : (
                            ...
                            <div className="lg:col-span-7 space-y-10">
                                ...
                                <div className="bg-white p-12 rounded-[4rem] border border-slate-100 shadow-xl shadow-slate-200/40 min-h-[500px] flex flex-col group">
                                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-8 relative z-10">
                                        ...
                                        >
                                            {submittingFile ? <i className="fa-solid fa-spinner fa-spin"></i> : <i className="fa-solid fa-upload text-lg"></i>}
