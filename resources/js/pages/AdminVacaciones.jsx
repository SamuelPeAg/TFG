            ...
            <div className="px-4 sm:px-8 h-16 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-slate-800 tracking-tight">Vacaciones</h1>
                            <p className="text-xs font-medium text-slate-500">Gestión de solicitudes de entrenadores</p>
                        </div>
                    </div>
                </div>
            </div>
