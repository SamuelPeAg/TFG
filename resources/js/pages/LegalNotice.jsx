  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Aviso Legal</h1>
        <p className="mt-6 text-xl text-gray-500">Información legal y condiciones de uso</p>
      </div>
      ...
      <div className="prose prose-lg prose-blue max-w-none text-gray-600 space-y-10">
        ...
        <section>
          ...
          <div className="not-prose bg-gray-50 p-8 rounded-2xl border-2 border-gray-100 shadow-sm mt-4">
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start"><span className="font-bold w-40 shrink-0">Titular:</span> <span>[TU NOMBRE O RAZÓN SOCIAL]</span></li>
              <li className="flex items-start"><span className="font-bold w-40 shrink-0">NIF/CIF:</span> <span>[TU NÚMERO DE IDENTIFICACIÓN]</span></li>
              <li className="flex items-start"><span className="font-bold w-40 shrink-0">Domicilio:</span> <span>[TU DIRECCIÓN COMPLETA]</span></li>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">3. Uso del Portal</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">4. Propiedad Intelectual e Industrial</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">5. Exclusión de Garantías y Responsabilidad</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">7. Legislación Aplicable y Jurisdicción</h2>
