  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Política de Cookies</h1>
        <p className="mt-6 text-xl text-gray-500">Transparencia sobre el uso de tecnologías de rastreo</p>
      </div>
      ...
      <div className="prose prose-lg prose-blue max-w-none text-gray-600 space-y-10">
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">2. Cookies utilizadas en este sitio web</h2>
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mt-4">
            <h3 className="text-xl font-bold text-gray-900 mb-4 mt-0">Cookies Propias</h3>
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mt-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4 mt-0">Cookies de Terceros</h3>
            <p className="mb-2">Esta web puede utilizar servicios de terceros que recopilan información con fines estadísticos y de uso de la web:</p>
            <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">3. Desactivación o eliminación de cookies</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 not-prose">
            <a href="https://support.google.com/chrome/answer/95647?hl=es" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:shadow-md hover:border-brandTeal transition group">
              <i className="fa-brands fa-chrome text-2xl text-gray-500 group-hover:text-brandTeal mr-3"></i>
              <span className="font-medium text-gray-700 group-hover:text-brandTeal">Google Chrome</span>
            </a>
            <a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:shadow-md hover:border-brandTeal transition group">
              <i className="fa-brands fa-firefox text-2xl text-gray-500 group-hover:text-brandTeal mr-3"></i>
              <span className="font-medium text-gray-700 group-hover:text-brandTeal">Mozilla Firefox</span>
            </a>
            <a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:shadow-md hover:border-brandTeal transition group">
              <i className="fa-brands fa-safari text-2xl text-gray-500 group-hover:text-brandTeal mr-3"></i>
              <span className="font-medium text-gray-700 group-hover:text-brandTeal">Safari</span>
            </a>
            <a href="https://support.microsoft.com/es-es/microsoft-edge/eliminar-las-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:shadow-md hover:border-brandTeal transition group">
              <i className="fa-brands fa-edge text-2xl text-gray-500 group-hover:text-brandTeal mr-3"></i>
              <span className="font-medium text-gray-700 group-hover:text-brandTeal">Microsoft Edge</span>
            </a>
          </div>
        </section>

        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">4. Notas adicionales</h2>
