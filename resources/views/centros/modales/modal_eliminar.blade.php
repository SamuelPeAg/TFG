<div id="modalEliminar" class="modal-overlay">
    <div class="modal-card" style="max-width: 400px;">
        <button type="button" class="close-btn" id="btnCerrarModalEliminar">&times;</button>
        <div class="modal-header-custom">
            <div class="logo-simulado" style="color: #EF5D7A;">
                <i class="fas fa-exclamation-triangle"></i>
            </div>
            <h2 style="color: #EF5D7A;">¿Eliminar Centro?</h2>
        ...
        <div style="padding: 0 20px 20px; text-align: center;">
            ...
            <p style="font-size: 18px; font-weight: bold; color: #333; margin-bottom: 25px;">
                <i class="fas fa-building" style="color: #4BB7AE; margin-right: 8px;"></i>
                <span id="delete_nombre_centro"></span>
            </p>

            <form id="formEliminarCentro" method="POST" style="display: inline;">
                @csrf
                @method('DELETE')
