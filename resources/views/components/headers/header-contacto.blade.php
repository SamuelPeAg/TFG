                    ...
                    <div class="flex items-center gap-4 ml-4 border-l pl-6 border-gray-200">
                        ...
                        @else
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ auth()->user()->hasRole('admin') ? route('Estadisticas') : route('calendario') }}" class="flex items-center gap-3 group hover:opacity-80 transition-opacity duration-200">
