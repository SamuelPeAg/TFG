                        ...
                        <div class="pos-menu" style="display:flex; flex-direction:column; gap:20px;">
                            ...
                            <div>
                                <div class="pos-category-title" style="margin-top: 10px; padding-top: 15px; border-top: 1px dashed #cbd5e1; display:flex; justify-content:space-between; align-items:center;">
                                    Ajustes de Precio / Entrega Rápida
                                    <div style="display:flex; gap:8px;">
                                        <button type="button" id="btn-global-discount" class="pos-btn-icon" title="Descontar 2€ a cada sesión" style="color:#3b82f6; background:#eff6ff; width:auto; padding:0 12px; font-size:11px; font-weight:bold; letter-spacing:0.5px; text-transform:uppercase;">
                                            <i class="fa-solid fa-tags" style="margin-right:6px;"></i> -2€ Todos
                                        </button>
                                        <button type="button" class="quick-money-btn pos-btn-icon" data-val="0" title="Reiniciar a 0" style="color:#ef4444; background:#fef2f2; width:auto; padding:0 12px; font-size:11px; font-weight:bold; letter-spacing:0.5px; text-transform:uppercase;">
                                            <i class="fa-solid fa-rotate-left" style="margin-right:6px;"></i> Reiniciar
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="pos-sidebar">
                            <div class="pos-form-section">
                                <div class="pos-input-group">
                                    ...
                                    <select id="pos-tipo-empresa" class="pos-select">
                                        <option value="salud">Salud (0% IVA)</option>
                                        <option value="entrenamiento">Entrenamiento (21% IVA)</option>
                                    </select>
                                </div>
                                <div class="pos-input-group">
                                    <label>Cliente</label>
                            ...
                            <div class="cart-footer">
                                <div class="cart-total" style="margin-bottom: 4px; font-size: 13px; color: #64748b;">
                                    <span>Subtotal:</span>
                                    <span id="cart-subtotal-value">0.00 €</span>
                                </div>
                                <div class="cart-total" style="margin-bottom: 8px; font-size: 13px; color: #64748b;">
                                    <span>IVA (21%):</span>
                                    <span id="cart-iva-value">0.00 €</span>
                                </div>
                                <div class="cart-total" style="margin-bottom: 12px; padding-top: 8px; border-top: 1px solid #e2e8f0;">
                                    <strong>Total Cuenta:</strong>
                                    <span id="cart-total-value" style="font-weight:bold; font-size: 1.2rem;">0.00 €</span>
                                </div>
                                <div class="cart-total" style="align-items:center; border-top: 1px dashed #cbd5e1; padding-top: 8px; margin-bottom: 8px; display:none;">
                                ...
                                <div id="pos-cambio-container" style="display:none; text-align:right; font-size:12px; color:#64748b; margin-bottom:12px;">
                                    Diferencia: <span id="pos-cambio-value" style="font-weight:bold; color:#10b981;">0.00 €</span>
                                </div>
