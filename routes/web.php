...
// Registrar errores del frontend en el log del backend desactivado por seguridad
...
Route::get('/api/entrenador-by-token/{token}', [EntrenadorController::class, 'getTrainerByToken']);
