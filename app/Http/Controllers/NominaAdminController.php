...
class NominaAdminController extends Controller
{
    ...
    public function generar(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(['success' => true, 'message' => "Proceso finalizado: $generadas nóminas creadas y $actualizadas actualizadas para el mes $mes/$anio."]);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(['success' => true, 'message' => $mensaje, 'nomina' => $nomina]);
        }
    ...
    public function marcarPagado($id)
    {
        ...
        if (request()->wantsJson()) {
            return response()->json(['success' => true, 'message' => 'Nómina marcada como PAGADA.', 'nomina' => $nomina]);
        }
    ...
    public function destroy($id)
    {
        ...
        $nomina->delete();
        if (request()->wantsJson()) {
            return response()->json(['success' => true, 'message' => 'Nómina eliminada.']);
        }
